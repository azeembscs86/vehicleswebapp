    ...
    <div class="box box-info">
        ...
        <form class="form-horizontal" method="POST" action="{{url('/admin/vehicles/create')}}" role="form" enctype="multipart/form-data" data-toggle="validator" id="create_author">
            ...
            <section class="content">
                ...
                <input class="form-control input-lg" value="" name="vehicle_title" required="required" type="text" placeholder="Vehicle Title">
                </div>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <select disabled="disabled" name="season_id" id="season_id" class="form-control">
                                    </select>
                                </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <select disabled="disabled" name="company_id" id="company_id" class="form-control">
                                    </select> 
                                </div>
                                <!-- /.form-group -->
                        ...
                        <div class="box box-primary">
                            ...
                            <div class="box-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" name="engine_size" class="form-control" id="inputEmail3">
                                    </div>
                                </div>
                    ...
                    <div class="box box-primary">
                           ...
                           @endforeach
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="number" name="toll_fee" id="toll_fee" disabled="disabled" class="form-control" placeholder="Toll Fee" min="1">
                                    </div>
                                </div>
                                <div class="form-group">
